...
router.post("/api/chat/assistant", async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    const systemInstructionText = "You are a professional BIM Assistant, an AI assistant integrated into a 3D BIM viewer (NEXBIM). " +
      ...
      "    \"value\": \"IfcColumn\" | 12345 | [12345, 67890] | \"search_query_string\" | \"Viewer\" | \"BCFManager\" | \"Queries\" | \"Properties\" | \"ViewPoints\" | \"RuleCheck\" | \"Quantities\" | \"ClashDetection\" | \"DrawingEditor\" | \"Timeline\" | {\"entity\": \"Slab\", \"attributeName\": \"PredefinedType\", \"attributeValue\": \"BASESLAB\", \"layout\": \"Quantities\"}\n" +
      "  }\n" +
      "}\n" +
      ...
      "- For switching layout tabs (Viewer, BCFManager, Queries, Properties, ViewPoints, RuleCheck, Quantities, ClashDetection, DrawingEditor, Timeline), set type='switchTab', target='layout', and value=layoutName.\n" +
