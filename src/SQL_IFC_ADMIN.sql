...
-- ==========================================
-- PROJECT & USER PERMISSION TABLES
-- ==========================================
...
ALTER TABLE "ifc" ADD "project_id" NUMBER NULL;
ALTER TABLE "ifc" ADD CONSTRAINT "fk_ifc_project" FOREIGN KEY ("project_id") REFERENCES "project"("id") ON DELETE SET NULL;

ALTER TABLE "frag" ADD "project_id" NUMBER NULL;
ALTER TABLE "frag" ADD CONSTRAINT "fk_frag_project" FOREIGN KEY ("project_id") REFERENCES "project"("id") ON DELETE SET NULL;

ALTER TABLE "project" ADD "code" VARCHAR2(10);
ALTER TABLE "project" ADD CONSTRAINT "uq_project_code" UNIQUE ("code");
